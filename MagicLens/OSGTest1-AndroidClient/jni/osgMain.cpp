...
void osgMain::draw()
{
    ...
    osg::Matrixd rotXNode;
    osg::Matrixd rotYNode;
    ...
    //25, 25-15, 25; 000
    viewer.getCamera()->setViewMatrixAsLookAt(osg::Vec3d(matrix[16]*25, matrix[17]*25 - 30,matrix[18]*25),osg::Vec3d(0,0,0),osg::Vec3d(0,0,1));
	viewer.frame();
}
...
void osgMain::recvMSG()
{
	...
	else
	{
		...
		for(int i=0;i<4;i++)
			...
			__android_log_print(ANDROID_LOG_INFO,"OURmatrix","%f, %f, %f",matrix[16],matrix[17],matrix[18]);
	}
}
